...
export const APPLICATION_ERRORS: {
  ...
  [ApplicationErrors.INCOMPATIBLE]: {errorCode: ApplicationErrors.INCOMPATIBLE, statusCode: 424},
  ...
  [ApplicationErrors.FORBIDDEN]: {errorCode: ApplicationErrors.FORBIDDEN, statusCode: 403},
